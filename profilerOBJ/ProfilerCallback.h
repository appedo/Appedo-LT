    ...
    public ICorProfilerCallback3
{
    ...
    public:
		...
		void SendLog(WCHAR* test, WCHAR* type);
        //
        // IUnknown 
        //
    ...
    private:
		...
		void LogToAny1(const char *format, ...);
		void LogFunction(FunctionID functionID);
		...
		HRESULT _LogCallTrace(FunctionID functionID, bool Enter);
