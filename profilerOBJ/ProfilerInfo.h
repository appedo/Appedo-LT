...
class FunctionInfoTrace :
	public BaseInfo
{
public:

	FunctionInfoTrace(FunctionID functionID, SIZE_T internal = 0);
	virtual ~FunctionInfoTrace();
...
{             
    ...
    protected:    
		...
		Table<FunctionInfoTrace *, FunctionID> *m_pFunctionTraceTable;
