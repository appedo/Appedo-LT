...
namespace AppedoLT
{
    partial class UCScriptSetting
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtIteration = new AppedoLT.Core.IntTextBox();
            ...
            this.txtMaxuser = new AppedoLT.Core.IntTextBox();
            this.radLabel4 = new Telerik.WinControls.UI.RadLabel();
            this.radLabel5 = new Telerik.WinControls.UI.RadLabel();
            this.lblTime = new Telerik.WinControls.UI.RadLabel();
            this.txtIncrementUser = new AppedoLT.Core.IntTextBox();
            this.ucIncrementTime = new AppedoLT.Core.UCTime();
            this.ucDurationTime = new AppedoLT.Core.UCTime();
            this.lblUserCount = new Telerik.WinControls.UI.RadLabel();
            this.txtStatUserCount = new AppedoLT.Core.IntTextBox();
